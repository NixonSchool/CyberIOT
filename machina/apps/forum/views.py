...
class IndexView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        visibility_content_tree = context['forums']

        # Computes some global values.
        context['total_posts_count'] = sum(n.posts_count for n in visibility_content_tree.top_nodes)
        context['total_topics_count'] = sum(
            n.topics_count for n in visibility_content_tree.top_nodes
        )
...
class ForumView(ListView):
    ...
    template_name = 'machina/forum/forum_detail.html'
