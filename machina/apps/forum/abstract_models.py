"""
    ...
    This module defines abstract models for a forum application,
    implementing a hierarchical forum structure with categories and links,
    and managing attributes such as posts count, last post information,
    and image uploads.
...
class AbstractForum(MPTTModel, DatedModel):
    ...
    # Url friendly version of a name so that My First Post can be represented well in the url eg my-first-post
