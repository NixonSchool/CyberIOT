...
class TopicLockView(PermissionRequiredMixin, SingleObjectTemplateResponseMixin, BaseDetailView):
    ...
    template_name = 'machina/forum_moderation/topic_lock.html'
...
class TopicUnlockView(PermissionRequiredMixin, SingleObjectTemplateResponseMixin, BaseDetailView):
    ...
    context_object_name = 'topic'
    model = Topic
    template_name = 'machina/forum_moderation/topic_unlock.html'
...
class TopicDeleteView(PermissionRequiredMixin, DeleteView):
    ...
    template_name = 'machina/forum_moderation/topic_delete.html'
...
class TopicMoveView(
    ...
    template_name = 'machina/forum_moderation/topic_move.html'
...
class TopicUpdateTypeBaseView(
    ...
    template_name = 'machina/forum_moderation/topic_update_type.html'
...
class TopicUpdateToAnnounceView(TopicUpdateTypeBaseView):
    """ Provides the ability to switch a topic to an announcement. """
...
class ModerationQueueListView(PermissionRequiredMixin, ListView):
    ...
    template_name = 'machina/forum_moderation/moderation_queue/list.html'
...
class ModerationQueueDetailView(PermissionRequiredMixin, DetailView):
    ...
    model = Post
    template_name = 'forum_templates/machina/forum_moderation/moderation_queue/detail.html'
...
class PostApproveView(PermissionRequiredMixin, SingleObjectTemplateResponseMixin, BaseDetailView):
    ...
    template_name = 'machina/forum_moderation/moderation_queue/post_approve.html'
...
class PostDisapproveView(
    ...
    template_name = 'machina/forum_moderation/moderation_queue/post_disapprove.html'
