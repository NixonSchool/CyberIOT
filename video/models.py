...
class Video(models.Model):
    ...
    likes = models.ManyToManyField(
        settings.AUTH_USER_MODEL, related_name="video_posts", blank=True
    )
...
class WatchLater(models.Model):
    ...
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL, verbose_name='Author', on_delete=models.CASCADE
    )
    channel = models.ForeignKey(
