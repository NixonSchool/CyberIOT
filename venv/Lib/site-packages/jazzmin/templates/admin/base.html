...
<head>
    ...
    <meta name="robots" content="none, noarchive">  <!-- Prevent admin panel from being crawled by search engines -->
    ...
    <style>
        html, body {
            font-family: 'Poppins', sans-serif; /* Apply Poppins font to HTML and body */
            font-size: smaller;
        }
    </style>
...
<body class="hold-transition
    {% if not jazzmin_settings.show_sidebar %}no-sidebar{% else %}sidebar-mini{% endif %}
    {% sidebar_status request %}
    {% if is_popup %}popup {% endif %}
    {% block bodyclass %}{% endblock %}
    {{ jazzmin_ui.body_classes }}
    {% if jazzmin_ui.dark_mode_theme %}theme-dark{% endif %}
